...
export default function Header() {
  return (
    ...
    <div className="text-white  bg-black flex ">
     ...
     <h2 className='p-7'>Inicio</h2>
     <h2 className='p-7'>Séries</h2>
     <h2 className='p-7'>Filmes</h2>
     <h2 className='p-7'>Bombando</h2>
     <h2 className='p-7'>Minha lista</h2>
     <h2 className='p-7'>Navegar por idiomas</h2> 
